...
// Load accounts from localStorage safely
let accounts: any[] = [];
try {
    ...
    console.error('Invalid accounts data in localStorage:', e);
    accounts = [];
}
            ...
            if (account.role === Role.Admin) {
                ...
                setTimeout(() => {
                    ...
                    alertService.info(`
                        ...
                        <div><strong>NOTE:</strong> This fake backend displayed this "email" so you can test without an API. A real backend would send a real email.</div>
                    `, { autoClose: false });
                }, 1000);
            }
